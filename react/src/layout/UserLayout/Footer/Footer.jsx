...
const Footer = () => {
    const handleLinkToFacebook = () => {
        let linkFace = "https://www.facebook.com/thanh.nguyenminh.75436531";
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6} md={6}>
                            ...
                            >
                                ...
                                <div className="widget-content">
                                    <p>Chúng tôi với nhiều năm kinh nghiệm trong lĩnh vực tư vấn - thiết kế - xây dựng.</p>
                                    <p>Dự án của Archi là sự kết hợp giữa NGHỆ THUẬT KIẾN TRÚC và CÔNG NĂNG SỬ DỤNG.</p>
                                    <p>Chúng tôi làm việc với phương châm CHÚNG TÔI SÁNG TẠO, BẠN TẬN HƯỞNG.</p>
